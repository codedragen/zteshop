...
<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="/admin.php/index/index">后台</a>
							</li>
					...
					<div class="page-content">
						...
						离本月（9）结束还有<span id="day_show" style="height:0px;">0天</span>
								...
								<div class="row">
									...
									<foreach>		
										<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php if(is_array($data)): foreach($data as $key=>$sale): ?><tr>
														<td class="center">
															<label>
														...
														<td><?php echo ($sale["goodsname"]); ?></td>
														<td class="hidden-480"><img src="/Public/upload/<?php echo ($sale["firstpic"]); ?>" width="50px"></td>
                                                       
                                                        <td><?php echo ($sale["price"]); ?></td>
                                                        <td><?php echo (date("y-m-d",$sale["uptime"])); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																

																 <a href="/admin.php/Goods/saledel/id/<?php echo ($sale["id"]); ?>" class="btn btn-xs">取消特惠</a>		
 ...
 <script type="text/javascript">
var intDiff = parseInt(1870000);//倒计时总秒数量
