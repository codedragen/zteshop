	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="/admin.php/Group/index">组管理</a>
				</li>
					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/admin.php/Group/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<th class="center">
												<label>
													<input type="checkbox" class="ace" onclick="$(':checkbox').attr('checked',true);" />
													<span class="lbl"></span>
												</label>
											</th>
											<th>id</th>
											<th>组名称</th>
											<th class="hidden-480">组状态</th>
											<th>规则</th>
											<th>操作</th>
										</tr>
									</thead>
									...
									<tbody>
									<?php if(is_array($groups)): foreach($groups as $key=>$group): ?><tr>
											<td class="center">
												<label>
													<input type="checkbox" class="ace"  name="ids[]" value="<?php echo ($group["id"]); ?>" />
													<span class="lbl"></span>
												</label>
											</td>
											<td>
												<a href="#"><?php echo ($group["id"]); ?></a>
											</td>
											<td><?php echo ($group["title"]); ?></td>
											<td><?php echo ($group["status"]); ?></td>
											<td><?php echo ($group["rules"]); ?></td>
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												

													<a href="/admin.php/Group/mod/id/<?php echo ($group["id"]); ?>" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120"></i>
													</a>

													<a href="/admin.php/Group/del/id/<?php echo ($group["id"]); ?>" class="btn btn-xs btn-danger">
