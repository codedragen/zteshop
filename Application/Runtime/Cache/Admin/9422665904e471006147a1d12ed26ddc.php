...
<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		...
		<div class="nav-search" id="nav-search">
				<span> 	 
			          <input type="text"  name="goodsname" class="nav-search-input" id="nav-search-input" autocomplete="off" />
					...
					<div class="col-xs-12">
						<div class="table-responsive">
							...
							<table id="sample-table-1" class="table table-striped table-bordered table-hover">
								...
								<tbody>
								<?php if(is_array($data)): foreach($data as $key=>$com): ?><tr>
										<td class="center">
											<label>
										...
										<td><?php echo ($com["goodsname"]); ?></td>
										<td><img src="/Public/upload/<?php echo ($com["firstpic"]); ?>" height="25px"></td>
										<td><?php echo ($com["username"]); ?></td>
										<td><?php echo ($com["ptime"]); ?></td>
										<td><?php echo ($com["com_contain"]); ?></td>
										<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
											  
											<a href="/admin.php/Comment/del/id/<?php echo ($com["id"]); ?>" class="btn btn-xs btn-danger">
	                        ...
	                        <div class="black2"><?php echo ($page); ?></div>
