					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/admin.php/Flink/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover">
									...
									<?php if(is_array($data)): foreach($data as $key=>$data): ?><tr>
											<td class="center">
												<label>
													<input type="checkbox" class="ace"  name="ids[]" value="<?php echo ($data["id"]); ?>" />
													<span class="lbl"></span>
												</label>
											</td>
											<td>
											...
											<td class="hidden-480"><?php echo ($data["link_url"]); ?></td>
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
												

													<a href="/admin.php/Flink/mod/id/<?php echo ($data["id"]); ?>" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120"></i>
													</a>

													<a href="/admin.php/Flink/del/id/<?php echo ($data["id"]); ?>" class="btn btn-xs btn-danger">
