        ...
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                <li>
                    ...
                    <a href="/admin.php/index/index.html">主页</a>
                </li>
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form class="form-horizontal" action='/admin.php/Webconfig/update' role="form" method='post' enctype='multipart/form-data'>
                        <br/>  <br/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 网站名称：</label>

                            <div class="col-sm-9">
                                <input type="text" id="form-field-1"  class="col-xs-10 col-sm-5"  name="title" value="<?php echo ($webinfo['title']); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name='keywords' id="form-field-2"  class="col-xs-10 col-sm-5"
                                       name="keywords" value="<?php echo ($webinfo['keywords']); ?>"/>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="description" id="form-field-2"  class="col-xs-10 col-sm-5" value="<?php echo ($webinfo['description']); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="isopen" type="radio" value="1" <?php echo ($webinfo['isopen'] ? 'checked':''); ?> />开启  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input name="isopen" type="radio" value="0" <?php echo ($webinfo['isopen'] ? '':'checked'); ?>/>关闭
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="copyright" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($webinfo['copyright']); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="icpno" id="form-field-2" class="col-xs-10 col-sm-5" value="<?php echo ($webinfo['icpno']); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div id='view' style=" width:416px;height:110px;border:1px solid #ddd;overflow:hidden;">
                                    <img id="imghead" width="416" height="110" border=0  src='/Public/home/images/logo1.png'/>
                                </div>
                                <br/>
