								...
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">
												...
												<?php if(is_array($data)): foreach($data as $key=>$user): ?><tr>
														...
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																...
																<a href="/admin.php/User/mod/id/<?php echo ($user["id"]); ?>" class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</a>

																<a href="/admin.php/User/del/id/<?php echo ($user["id"]); ?>" class="btn btn-xs btn-danger">
											...
											<div class="tres"><?php echo ($pageinfo); ?></div>
