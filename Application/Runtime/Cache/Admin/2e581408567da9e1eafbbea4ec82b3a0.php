...
<html lang="en">
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">					
					<form action="/admin.php/Flink/add" method="post" class="form-horizontal" role="form">
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 链接名称： </label>
							<div class="col-sm-9">
								<input type="text" name="link_name" id="form-field-1" placeholder="link_name" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" name="link_url" id="form-field-2" placeholder="link_url" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="space-4"></div>
