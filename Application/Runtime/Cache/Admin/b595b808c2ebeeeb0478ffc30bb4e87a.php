							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<p>
											<a href="/admin.php/user/add" class="btn btn-default btn-app radius-6">
												<i class="icon-user bigger-230"></i>
												添加用户
											</a>
											
											<a href="/admin.php/goods/add" class="btn btn-yellow btn-app radius-6">
												<i class="icon-edit bigger-230"></i>
												添加商品
											</a>
											
											<a href="/admin.php/order/index" class="btn btn-app btn-info">
												<i class=" icon-folder-open bigger-230"></i>
												订单管理
											</a>
											
											<a href="/admin.php/goods/monthsalelist" class="btn btn-app btn-success">
												<i class="icon-gift bigger-230"></i>
												本月特惠
											</a>

											<a href="/admin.php/comment/index" class="btn btn-app btn-purple">
												<i class="icon-comment bigger-230"></i>
												评论管理
											</a>
										</p>
									</div>
								...
								<div class="table-responsive">
									<form action="/admin.php/Index/del" method="post">
